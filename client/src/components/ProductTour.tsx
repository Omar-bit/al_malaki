...
const desktopSteps: DriveStep[] = [
  {
    ...
    popover: {
      title: 'Welcome to Al Malaki',
      description: 'This is our logo — click it anytime to come back home.',
      side: 'bottom',
    },
  },
  {
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Search our catalogue for the honey product you are looking for.',
      side: 'bottom',
    },
  },
  {
    ...
    popover: {
      title: 'Your cart',
      description: 'Items you add stay here — open it anytime to review or checkout.',
      side: 'bottom',
    },
  },
  {
    ...
    popover: {
      title: 'Your account',
      description: 'Track your orders, loyalty points, and profile here.',
      side: 'bottom',
    },
  },
  {
    ...
    popover: {
      ...
      description: 'Switch between English, French, and Arabic whenever you like.',
      side: 'bottom',
    },
  },
];
...
const mobileSteps: DriveStep[] = [
  {
    ...
    popover: {
      title: 'Welcome to Al Malaki',
      description: 'Tap here to open the menu and browse the site.',
      side: 'bottom',
    },
  },
  {
