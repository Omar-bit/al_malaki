  ...
  return (
    <section id='products' className='bg-cream p-5'>
      <div className='mx-auto w-full  space-y-15 flex items-center justify-center flex-col'>
        <h2 className=' text-center font-(--font-abril) text-[50px] font-italic font-extrabold  leading-[1.1] text-dark-red '>
          Products
        </h2>
        ...
        <div className=' w-[100%] items-center justify-center  grid grid-cols-1 justify-items-center gap-10 md:grid-cols-3 md:gap-[47px]'>
          {products.map((product) => (
            <article key={product.id} className='w-[400px] '>
              <div className='h-[400px]  w-full  bg-[#d9d9d9] '></div>
              <h3 className='mt-[20px] text-center font-[var(--font-abhaya)] text-4xl !font-semibold font-italic leading-[1.05] text-black'>
                {product.name}
              </h3>
